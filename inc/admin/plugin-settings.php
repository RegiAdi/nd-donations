				...
				<div class="nd_donations_width_80_percentage nd_donations_margin_left_20_percentage nd_donations_float_left nd_donations_box_sizing_border_box nd_donations_padding_20">
					...
					<div class="nd_donations_section">
						...
						<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							...
							<input <?php if (get_option('nd_donations_container') == 1) {
										echo 'checked="checked"';
									} ?> name="nd_donations_container" type="checkbox" value="1">
					...
					<div class="nd_donations_section">
						...
						<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							...
							<input <?php if (get_option('nd_donations_plugin_dev_mode') == 1) {
										echo 'checked="checked"';
									} ?> name="nd_donations_plugin_dev_mode" type="checkbox" value="1">
...
/////////////////////////////////////////////////// START XENDIT SETTINGS ///////////////////////////////////////////////////////////////

add_action('nd_donations_add_menu_settings', 'nd_donations_add_xendit_settings');
function nd_donations_add_xendit_settings()
{
	add_submenu_page('nd-donations-settings', 'ND Booking', __('Xendit Settings', 'nd-donations'), 'manage_options', 'nd-donations-xendit-settings', 'nd_donations_xendit_page');
	add_action('admin_init', 'nd_donations_xendit_settings');
}

function nd_donations_xendit_settings()
{
	register_setting('nd_donations_xendit_settings_group', 'nd_donations_xendit_test_mode');
	register_setting('nd_donations_xendit_settings_group', 'nd_donations_xendit_api_key_test');
	register_setting('nd_donations_xendit_settings_group', 'nd_donations_xendit_api_key_live');
}

function nd_donations_xendit_page()
{
?>
	<form method="post" action="options.php">
		<?php settings_fields('nd_donations_xendit_settings_group'); ?>
		<?php do_settings_sections('nd_donations_xendit_settings_group'); ?>
			...
			<div class="nd_donations_section  nd_donations_box_shadow_0_1_1_000_04 nd_donations_background_color_ffffff nd_donations_border_1_solid_e5e5e5 nd_donations_border_top_width_0 nd_donations_border_left_width_0 nd_donations_overflow_hidden nd_donations_position_relative">
				...
				<div style="background-color:<?php echo nd_donations_get_profile_bg_color(1); ?>;" class="nd_donations_width_20_percentage nd_donations_float_left nd_donations_box_sizing_border_box nd_donations_min_height_3000 nd_donations_position_absolute">
					<ul class="nd_donations_navigation">
						...
						<li><a style="background-color:<?php echo nd_donations_get_profile_bg_color(2); ?>;" class="" href=""><?php _e('Xendit Settings', 'nd-donations'); ?></a></li>
						<li><a class="" href="<?php echo admin_url('admin.php?page=nd-donations-paypal-settings'); ?>"><?php _e('Paypal Settings', 'nd-donations'); ?></a></li>
						<li><a class="" href="<?php echo admin_url('admin.php?page=nd-donations-offline-donations-page'); ?>"><?php _e('Offline Donations', 'nd-donations'); ?></a></li>
						<li><a class="" href="<?php echo admin_url('admin.php?page=nd-donations-paypal-donations-page'); ?>"><?php _e('Paypal Donations', 'nd-donations'); ?></a></li>
						<li><a class="" href="<?php echo admin_url('admin.php?page=nd-donations-settings-import-export'); ?>"><?php _e('Import Export', 'nd-donations'); ?></a></li>
				...
				<div class="nd_donations_width_80_percentage nd_donations_margin_left_20_percentage nd_donations_float_left nd_donations_box_sizing_border_box nd_donations_padding_20">
					...
					<div class="nd_donations_section">
						<div class="nd_donations_width_40_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<h2 class="nd_donations_section nd_donations_margin_0"><?php _e('Xendit Settings', 'nd-donations'); ?></h2>
							<p class="nd_donations_color_666666 nd_donations_section nd_donations_margin_0 nd_donations_margin_top_10"><?php _e('Below are some important xendit settings.', 'nd-donations'); ?></p>
						</div>
					</div>
					<!--END-->
					<div class="nd_donations_section nd_donations_height_1 nd_donations_background_color_E7E7E7 nd_donations_margin_top_10 nd_donations_margin_bottom_10"></div>

					<!-- START Enable Xendit Test Mode -->
					<div class="nd_donations_section">
						<div class="nd_donations_width_40_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<h2 class="nd_donations_section nd_donations_margin_0"><?php _e('Xendit Test Mode', 'nd-donations'); ?></h2>
							<p class="nd_donations_color_666666 nd_donations_section nd_donations_margin_0 nd_donations_margin_top_10">
								<?php _e('Enable Xendit test mode', 'nd-donations'); ?>
							</p>
						</div>

						<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<input <?php if (get_option('nd_donations_xendit_test_mode') == 1) {
										echo 'checked="checked"';
									} ?> name="nd_donations_xendit_test_mode" type="checkbox" value="1">
						</div>
					</div>
					<!--END-->

					<div class="nd_donations_section nd_donations_height_1 nd_donations_background_color_E7E7E7 nd_donations_margin_top_10 nd_donations_margin_bottom_10"></div>
					<!--START Test Mode API Key-->
					<div class="nd_donations_section">
						<div class="nd_donations_width_40_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<h2 class="nd_donations_section nd_donations_margin_0"><?php _e('Test Mode API Key', 'nd-donations'); ?></h2>
							<p class="nd_donations_color_666666 nd_donations_section nd_donations_margin_0 nd_donations_margin_top_10"><?php _e('Enter your Xendit Test API Key', 'nd-donations'); ?></p>
						</div>
						<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<input class="regular-text" type="text" name="nd_donations_xendit_api_key_test" value="<?php echo esc_attr(get_option('nd_donations_xendit_api_key_test')); ?>" />
						</div>
					</div>
					<!--END-->
					<div class="nd_donations_section nd_donations_height_1 nd_donations_background_color_E7E7E7 nd_donations_margin_top_10 nd_donations_margin_bottom_10"></div>

					<!--START Live Mode API Key-->
					<div class="nd_donations_section">
						<div class="nd_donations_width_40_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<h2 class="nd_donations_section nd_donations_margin_0"><?php _e('Live Mode API Key', 'nd-donations'); ?></h2>
							<p class="nd_donations_color_666666 nd_donations_section nd_donations_margin_0 nd_donations_margin_top_10"><?php _e('Enter your Xendit Live API Key', 'nd-donations'); ?></p>
						</div>
						<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							<input class="regular-text" type="text" name="nd_donations_xendit_api_key_live" value="<?php echo esc_attr(get_option('nd_donations_xendit_api_key_live')); ?>" />
						</div>
					</div>
					<!--END-->
					<div class="nd_donations_section nd_donations_height_1 nd_donations_background_color_E7E7E7 nd_donations_margin_top_10 nd_donations_margin_bottom_10"></div>
				...
				<div class="nd_donations_width_80_percentage nd_donations_margin_left_20_percentage nd_donations_float_left nd_donations_box_sizing_border_box nd_donations_padding_20">
					...
					<div class="nd_donations_section">
						...
						<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
							...
							<input <?php if (get_option('nd_donations_paypal_developer') == 1) {
										echo 'checked="checked"';
									} ?> name="nd_donations_paypal_developer" type="checkbox" value="1">
