				...
				<div class="nd_donations_section  nd_donations_box_shadow_0_1_1_000_04 nd_donations_background_color_ffffff nd_donations_border_1_solid_e5e5e5 nd_donations_border_top_width_0 nd_donations_border_left_width_0 nd_donations_overflow_hidden nd_donations_position_relative">
					...
					<div style="background-color:<?php echo nd_donations_get_profile_bg_color(1); ?>;" class="nd_donations_width_20_percentage nd_donations_float_left nd_donations_box_sizing_border_box nd_donations_min_height_3000 nd_donations_position_absolute">
						...
						<ul class="nd_donations_navigation">
							...
							<li><a class="" href="<?php echo admin_url('admin.php?page=nd-donations-xendit-settings'); ?>"><?php _e('Xendit Settings', 'nd-donations'); ?></a></li>
					...
					<div class="nd_donations_width_80_percentage nd_donations_margin_left_20_percentage nd_donations_float_left nd_donations_box_sizing_border_box nd_donations_padding_20">
						...
						<div class="nd_donations_section">
							...
							<div class="nd_donations_width_60_percentage nd_donations_padding_20 nd_donations_box_sizing_border_box nd_donations_float_left">
								...
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_documents_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_documents_enable" type="checkbox" value="1"> <?php _e('Documents', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_fixed_donation_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_fixed_donation_enable" type="checkbox" value="1"> <?php _e('Fixed Donation', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_info_donation_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_info_donation_enable" type="checkbox" value="1"> <?php _e('Info Donation', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_comments_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_comments_enable" type="checkbox" value="1"> <?php _e('Comments', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_donors_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_donors_enable" type="checkbox" value="1"> <?php _e('Donors', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_free_tab_content_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_free_tab_content_enable" type="checkbox" value="1"> <?php _e('Free Tab Content', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_header_img_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_header_img_enable" type="checkbox" value="1"> <?php _e('Header Image', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_testimonial_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_testimonial_enable" type="checkbox" value="1"> <?php _e('Testimonial', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_urgent_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_urgent_enable" type="checkbox" value="1"> <?php _e('Urgent', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_message_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_message_enable" type="checkbox" value="1"> <?php _e('Mail on Order', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_sidebar_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_sidebar_enable" type="checkbox" value="1"> <?php _e('Sidebar on Single Cause', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_pagination_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_pagination_enable" type="checkbox" value="1"> <?php _e('Pagination on Single Cause', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_slug_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_slug_enable" type="checkbox" value="1"> <?php _e('Slug Post Type', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_visualcomposer_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_visualcomposer_enable" type="checkbox" value="1"> <?php _e('Visual Composer', 'nd-donations'); ?></label>
								<div class="nd_donations_section nd_donations_height_20"></div>
								<label class="nd_donations_section"><input <?php if (get_option('nd_donations_elementor_enable') == 1) {
																				echo 'checked="checked"';
																			} ?> name="nd_donations_elementor_enable" type="checkbox" value="1"> <?php _e('Elementor', 'nd-donations'); ?></label>
